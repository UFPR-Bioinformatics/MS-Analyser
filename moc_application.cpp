...
**
** Created: Tue Apr 23 10:20:26 2013
...
static const char qt_meta_stringdata_Application[] = {
    ...
    "pk_panel_item_edited(QWidget*)\0"
    "export_files()\0addDatabase(QAction*)\0"
    "searchDatabase(QAction*)\0"
    "setPlotInterval(int,int)\0infoChanged()\0"
    "modeChanged(int)\0plotPeakWeigth(int)\0"
    "plotShowSpectrum(int)\0"
...
void Application::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 14: _t->pk_panel_item_edited((*reinterpret_cast< QWidget*(*)>(_a[1]))); break;
        case 15: _t->export_files(); break;
        case 16: _t->addDatabase((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 17: _t->searchDatabase((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
        case 18: _t->setPlotInterval((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 19: _t->infoChanged(); break;
        case 20: _t->modeChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 21: _t->plotPeakWeigth((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 22: _t->plotShowSpectrum((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 23: _t->peaklist_infotab_changed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
